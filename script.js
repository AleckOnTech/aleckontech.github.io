/* Initialize Date */
        const reldate = new Date(Date.UTC(2025, 9, 25, 12, 0, 0)); // Release Date in UTC
        ...
        window.onload = () =>{
            ...
            document.getElementById("second_line").innerHTML = "Website will be released and hosted on October 25, 2025 at 12:00PM (GMT) <br>or on your timezone: " + reldate.toLocaleString("en-US", options);;
